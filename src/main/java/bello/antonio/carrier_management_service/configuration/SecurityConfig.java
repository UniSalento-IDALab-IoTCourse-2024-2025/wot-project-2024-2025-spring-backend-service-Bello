...
public class SecurityConfig {
    ...
    public static PasswordEncoder passwordEncoder() {
        return new Argon2PasswordEncoder(
                16,     // saltLength: 16 byte
                32,     // hashLength: 32 byte
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers( "/api/carrier/authenticate", "/api/carrier/addUser", "/api/carrier/deleteUser", "/api/carrier/register", "/api/carrier/trip/startSimulation/{vehicleName}", "/api/carrier/trip/stopSimulation", "/api/carrier/simulation/status").permitAll()
